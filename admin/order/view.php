    ...
    <table class="table table-bordered">
        ...
        <tbody>
                <tr>
                    <td> 1 </td>
                    <td>patient one</td>
                    <td scope="col">patient1@hospital.com</td>
                    <td scope="col">01010101010</td>
                    <td scope="col">
                        City one
                    </td>
                    <td scope="col">
                ...
                <tr>
                    <td> 2 </td>
                    <td>patient two</td>
                    <td scope="col">patient2@hospital.com</td>
                    <td scope="col">01020202020</td>
                    <td scope="col">
                        City one
                    </td>
                    <td scope="col">
                ...
                <tr>
                    <td> 3 </td>
                    <td>patient three</td>
                    <td scope="col">patient3@hospital.com</td>
                    <td scope="col">01030303030</td>
                    <td scope="col">
                        City one
                    </td>
                    <td scope="col">
